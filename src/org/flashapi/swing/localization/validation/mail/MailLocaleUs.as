...
package org.flashapi.swing.localization.validation.mail {
	...
	*/
	...
	/**
	 * 	The <code>MailLocaleUs</code> class is used by <code>MailValidator</code>
	 * 	objects to display error messages in English-US.
	 * 
	 * 	<p>This is the default language class for mail validation services within
	 * 	the SPAS 3.0 API.</p>
	 * 
	 ...
	 */
	public class MailLocaleUs implements LocaleValidation {
		...
		/**
		 * 	Constructor. Creates a new <code>MailLocaleUs</code> object.
		 */
		public function MailLocaleUs() {
			super();
		}
