...
package org.flashapi.swing.localization.alert {
	...
	*/
	...
	/**
	 * 	The <code>AlertLocaleUs</code> class is an enumeration of constant values
	 * 	that contains US english labels to be used by buttons of <code>Alert</code>
	 * 	instances.
	 * 
	 * 	<p>The <code>AlertLocaleUs</code> class is the default class for  
	 * 	buttons labels of <code>Alert</code> instances.</p>
	 * 
	...
	public class AlertLocaleUs {
		 ...
		 * 				AlertLocaleUs instance.
		 */
		public function AlertLocaleUs() {
			super();
		 ...
		 */
		public static const CHOICE:String = "No"; 
