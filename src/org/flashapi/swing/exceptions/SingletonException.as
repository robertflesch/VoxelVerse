...
package org.flashapi.swing.exceptions {
	...
	// -----------------------------------------------------------
	// SingletonException.as
	// -----------------------------------------------------------
	
	/**
	* @author Pascal ECHEMANN
	* @version 1.0.0, 16/01/2008 21:20
	* @see http://www.flashapi.org/
	*/
	
	/**
	 * 	An <code>SingletonException</code> is thrown if an attempt is made to
	...
	public class SingletonException extends Error {
		...
		/**
		 * 	Constructor. Creates a new <code>SingletonException</code> object with
