...
package org.flashapi.swing.border {
	...
	// -----------------------------------------------------------
	// AbstractBorderContainer.as
	// -----------------------------------------------------------
	
	/**
	* @author Pascal ECHEMANN
	* @version 1.0.1, 18/12/2008 19:35
	...
	*/
	...
	/**
	 * 	The <code>AbstractBorderContainer</code> is the abstract superclass of
	 * 	<code>UIContainer</code> components that implement the API defined by
	 * 	the <code>Border</code> interface.
	 * 
	 ...
	 */
	public class AbstractBorderContainer extends UIContainer implements Border {
		 ...
		 * 
		 * 	Constructor. Creates a new <code>AbstractBorderContainer</code> instance.
		 */
		public function AbstractBorderContainer() {
			super();
			initObj();
		}
		 ...
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Stores the internal value for the <code>backgroundWidth</code> property.
		 * 
		 * 	@see #backgroundWidth
		 */
