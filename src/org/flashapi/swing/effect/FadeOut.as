...
package org.flashapi.swing.effect {
	...
	*/
	...
	/**
	 * 	The <code>FadeOut</code> class creates a fading effect from fully opaque to fully
	 * 	transparent.
	 * 
	 ...
	 */
	public class FadeOut extends FadeEffects implements Effect {
		...
		/**
		 * 	Constructor. Creates e new <code>FadeOut</code> effect with 
		 * 	the specified parameters.
		 * 
		 * 	@param	target		The target container for this effect.
		 * 	@param	duration	The effect duration, in milliseconds.
		 */
		public function FadeOut(target:Object, duration:uint = 500) {
