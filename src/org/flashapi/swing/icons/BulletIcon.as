...
package org.flashapi.swing.icons {
	...
	* @version 1.0.1, 20/01/2009 00:58
	...
	*/
	...
	/**
	 * 	The <code>BulletIcon</code> class is used to draw bullet icons.
	 * 
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class BulletIcon extends StateBrushBase implements StateBrush {
		 ...
		 */
		public function BulletIcon(target:*, rect:Rectangle = null, dto:LafDTO = null) {
		...
		override protected function drawBrushShape(state:String):void {
			...
			with($graphics) {
				clear();
				lineStyle(2, c, 1, true, LineScaleMode.NORMAL, CapsStyle.ROUND);
				for (; i >= 1; i--) {
					moveTo(unitX, i*unitY);
					lineTo(unitX + .5, i*unitY);
					moveTo(2 * unitX, i*unitY);
					lineTo(3 * unitX, i*unitY);
				}
				endFill();
			}
		}
