...
package org.flashapi.swing.icons {
	...
	* @version 1.0.0, 07/08/2009 00:47
	...
	*/
	...
	/**
	 * 	The <code>PreviousIcon</code> class is used to draw the icon of 
	 * 	<code>PreviousButton</code> instances.
	 * 
	 ...
	 */
	public class PreviousIcon extends StateBrushBase implements StateBrush {
		 ...
		 */
		public function PreviousIcon(target:*, rect:Rectangle = null, dto:LafDTO = null) {
		...
		override protected function drawBrushShape(state:String):void {
			...
			with($graphics) {
				clear();
				beginFill(c);
				moveTo(unitX, 2*unitY);
				lineTo(2*unitX, 3 * unitY);
				lineTo(2*unitX, unitY);
				lineTo(unitX, 2*unitY);
				moveTo(2*unitX, 2*unitY);
				lineTo(3*unitX, 3 * unitY);
				lineTo(3*unitX, unitY);
