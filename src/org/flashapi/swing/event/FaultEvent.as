...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 18:51
	...
	*/
	...
	/**
	 *  The <code>FaultEvent</code> class represents event objects specific to 
	 *  the remoting service objects.
	 * 
	 * 	@see org.flashapi.swing.net.remoting.AbstractRemotingService
	 * 	@see org.flashapi.swing.event.ResultEvent
	 *
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public final class FaultEvent extends SpasEvent {
		 ...
		 *	@param fault 	The object that contains the details of what caused
		 * 					this event.
		...
		/**
		 *  The <code>FaultEvent.FAULT</code> constant defines the value of the 
		...
		override public function clone():Event {
			return new FaultEvent(type, spas_internal::fault, bubbles, cancelable);
		}
		...
		private function initObj(fault:Object):void {
			spas_internal::fault = fault;
		}
	}
}