...
package org.flashapi.swing.event {
	...
	// -----------------------------------------------------------
	// ButtonsGroupEvent.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.3, 12/05/2011 18:10
	...
	*/
	...
	/**
	 *  The <code>ButtonsGroupEvent</code> class represents event objects specific to 
	 *  <code>GroupButtonBase</code> subclasses.
	 * 
	 * 	@see org.flashapi.swing.button.core.GroupButtonBase
	 *
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class ButtonsGroupEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>ButtonsGroupEvent</code> with the specified
		 * 	parameters.
		 *
		 ...
		 * 						can be prevented.
		 */
		public function ButtonsGroupEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false) {
		...
		/**
		 *  The <code>ButtonsGroupEvent.GROUP_CHANGED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>groupChanged</code>
		 * 	event.
		 * 
		...
		override public function clone():Event {
			return new ButtonsGroupEvent(type, bubbles, cancelable);
		}
	}
}