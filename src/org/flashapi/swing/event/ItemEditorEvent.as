...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 21:19
	...
	*/
	...
	/**
	 *  The <code>ItemEditorEvent</code> class represents event objects specific to 
	 *  item editor objects.
	 * 
	 * 	@see org.flashapi.swing.renderer.DefaultItemEditor
	 *
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class ItemEditorEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>ItemEditorEvent</code> with the specified
		 * 	parameters.
		 *
		 ...
		 * 						can be prevented.
		 */
		public function ItemEditorEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false) {
		...
		/**
		 *  The <code>ItemEditorEvent.VALIDATED</code> constant defines the value of the 
		...
		/**
		 *  The <code>ItemEditorEvent.CANCELED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>canceled</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		...
		override public function clone():Event {
			return new ItemEditorEvent(type, bubbles, cancelable);
		}
	}
}