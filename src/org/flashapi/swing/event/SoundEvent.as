...
package org.flashapi.swing.event {
	...
	* @version 1.0.3, 12/05/2011 21:37
	...
	*/
	...
	/**
	 *  The <code>SoundEvent</code> class represents event objects specific to 
	 *  sound objects.
	 * 
	 ...
	 */
	public class SoundEvent extends MediaEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>SoundEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>SoundEvent.ID3</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>id3</code>
		 * 	event.
		 * 
