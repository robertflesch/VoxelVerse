...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 21:38
	...
	*/
	...
	/**
	 *  The <code>SpasEvent</code> class is the base class for all events dispatched
	 ...
	 */
	public class SpasEvent extends Event {
		...
		/**
		 *  Constructor.	Creates a new <code>SpasEvent</code> with the specified
		 * 	parameters.
		 *
		 ...
		 * 						can be prevented.
		 */
		public function SpasEvent(type:String, bubbles:Boolean=false, cancelable:Boolean=false) {
		...
		/**
		 *  The <code>SpasEvent.DATA_CHANGED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>dataChanged</code>
		 * 	event.
		 * 
		...
		override public function clone():Event {
			return new SpasEvent(type, bubbles, cancelable);
		}
	}
}