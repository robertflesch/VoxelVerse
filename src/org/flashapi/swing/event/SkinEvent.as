...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 21:36
	...
	*/
	...
	/**
	 *  The <code>SkinEvent</code> class represents event objects specific to 
	 *  <code>Skinable</code> objects.
	 * 
	 ...
	 */
	public class SkinEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>SkinEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>CalendarEvent.SKIN_CHANGED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>skinChanged</code>
		 * 	event.
		 * 
