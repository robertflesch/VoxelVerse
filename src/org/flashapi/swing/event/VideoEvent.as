...
package org.flashapi.swing.event {
	...
	* @version 1.0.2, 12/05/2011 21:45
	...
	*/
	...
	/**
	 *  The <code>VideoEvent</code> class represents event objects specific to 
	 *  the <code>Video</code> class.
	 * 
	 * 	@see org.flashapi.swing.Video
	 *
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class VideoEvent extends MediaEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>VideoEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>VideoEvent.UPDATE</code> constant defines the value of the 
