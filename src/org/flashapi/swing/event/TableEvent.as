...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 21:41
	...
	*/
	...
	/**
	 *  The <code>TableEvent</code> class represents event objects specific to 
	 *  the <code>Table</code> class.
	 * 
	 ...
	 */
	public class TableEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>TableEvent</code> with the specified
		 * 	parameters.
		 *
		 ...
		 * 	@private
		 */
		spas_internal var cellRef:Cell;
		/**
		 * 	The <code>Cell</code> object that has caused this event.
		 */
		public function get cell():Cell {
			return spas_internal::cellRef;
		}
		...
		/**
		 *  The <code>TableEvent.CELL_CLICKED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>cellClicked</code>
		 * 	event.
		 * 
		...
		override public function clone():Event {
			var e:TableEvent = new TableEvent(type, bubbles, cancelable);
			e.spas_internal::cellRef = spas_internal::cellRef;
			return e;
		}
	}
}