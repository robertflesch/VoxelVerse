...
package org.flashapi.swing.event {
	...
	* @version 1.0.2, 12/05/2011 21:41
	...
	*/
	...
	/**
	 *  The <code>TextEvent</code> class represents event objects specific to 
	 *  text objects.
	 * 
	 * 	@see org.flashapi.swing.text.ATM
	 *
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class TextEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>TextEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>TextEvent.EDITED</code> constant defines the value of the 
		...
		/**
		 *  The <code>TextEvent.VALIDATED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>validated</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		...
		/**
		 *  The <code>TextEvent.TEXT_FOCUS_IN</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>textFocusIn</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType textFocusIn
		 */
		public static const TEXT_FOCUS_IN:String = "textFocusIn";
		
		/**
		 *  The <code>TextEvent.TEXT_FOCUS_OUT</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>textFocusOut</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
