...
package org.flashapi.swing.event {
	...
	* @version 1.0.2, 12/05/2011 21:24
	...
	*/
	...
	/**
	 *  The <code>LayoutEvent</code> class represents event objects specific to 
	 *  <code>Layout</code> classes.
	 * 
	 ...
	 */
	public class LayoutEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>LayoutEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>LayoutEvent.LAYOUT_FINISHED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>layoutFinished</code>
		 * 	event.
		 * 
		 ...
		 *  </table>
		 *
		 *  @eventType layoutFinished
		 */
		public static const LAYOUT_FINISHED:String = "layoutFinished";
		
		/**
		 *  The <code>LayoutEvent.LAYOUT_MANAGER_PROCESS_FINISHED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>layoutManagerProcessFinished</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType layoutManagerProcessFinished
		 */
		public static const LAYOUT_MANAGER_PROCESS_FINISHED:String = "layoutManagerProcessFinished";
