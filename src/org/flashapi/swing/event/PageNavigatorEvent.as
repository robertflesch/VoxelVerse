...
package org.flashapi.swing.event {
	...
	// -----------------------------------------------------------
	// PageNavigatorEvent.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.2, 12/05/2011 21:32
	...
	*/
	...
	/**
	 *  The <code>PageNavigatorEvent</code> class represents event objects specific to 
	 *  the <code>PageNavigator</code> class.
	 * 
	 ...
	 */
	public class PageNavigatorEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>PageNavigatorEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>PageNavigatorEvent.PAGE_CHANGED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>pageChanged</code>
		 * 	event.
		 * 
		...
		/**
		 *  The <code>PageNavigatorEvent.ITEM_CLICKED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>itemClicked</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		...
		override public function clone():Event {
			return new PageNavigatorEvent(type, bubbles, cancelable);
		}
	}
}