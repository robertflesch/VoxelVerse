...
package org.flashapi.swing.event {
	...
	* @version 1.0.2, 12/05/2011 18:02
	...
	*/
	...
	/**
	 *  The <code>ApplicationEvent</code> class represents event objects specific to 
	 ...
	 */
	public class ApplicationEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>ApplicationEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>ApplicationEvent.UPDATE</code> constant defines the value of the 
		...
		/**
		 *  The <code>ApplicationEvent.RESIZED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>resized</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		...
		/**
		 *  The <code>ApplicationEvent.STYLE_LOADED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>styleLoaded</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType styleLoaded
		 */
		public static const STYLE_LOADED:String = "styleLoaded";
