...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 25/02/2009 16:35
	...
	*/
	...
	/**
	 *  The <code>CalendarEvent</code> class represents event objects specific to 
	 *  the <code>Calendar</code> class.
	 * 
	 ...
	 */
	public class CalendarEvent extends SpasEvent {
		...
		/**
		 *  The <code>CalendarEvent.DATE_CHANGED</code> constant defines the value of the 
		...
		/**
		 *  The <code>CalendarEvent.DATE_CLICKED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>dateClicked</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType dateClicked
		 */
		public static const DATE_CLICKED:String = "dateClicked";
		
		/**
		 *  The <code>CalendarEvent.MONTH_SCROLL</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>monthScroll</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType monthScroll
		 */
		public static const MONTH_SCROLL:String = "monthScroll";
		
		/**
		 *  The <code>CalendarEvent.YEAR_SCROLL</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>yearScroll</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType yearScroll
		 */
		public static const YEAR_SCROLL:String = "yearScroll";
