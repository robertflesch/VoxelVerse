...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 21:33
	...
	*/
	...
	/**
	 *  The <code>ResizerEvent</code> class represents event objects specific to 
	 *  the <code>Resizer</code> class.
	 * 
	 ...
	 */
	public class ResizerEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>ResizerEvent</code> with the specified
		 * 					parameters.
		 *
		...
		/**
		 *  The <code>ResizerEvent.RESIZE_START</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>resizeStart</code>
		 * 	event.
		 * 
		...
		/**
		 *  The <code>ResizerEvent.RESIZE_UPDATE</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>resizeUpdate</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
		 ...
		 *  </table>
		 *
		 *  @eventType resizeUpdate
		 */
		public static const RESIZE_UPDATE:String = "resizeUpdate";
		
		/**
		 *  The <code>ResizerEvent.RESIZE_FINISH</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>resizeFinish</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
