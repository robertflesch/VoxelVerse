...
package org.flashapi.swing.event {
	...
	* @version 1.0.2, 12/05/2011 18:06
	...
	*/
	...
	/**
	 *  The <code>BrushEvent</code> class represents event objects specific to 
	 *  the <code>Brush</code> interface.
	 * 
	 ...
	 */
	public class BrushEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>BrushEvent</code> with the specified
		 * 	parameters.
		 *
		...
		/**
		 *  The <code>BrushEvent.DRAWN</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>drawn</code>
		 * 	event.
		 * 
		...
		/**
		 *  The <code>BrushEvent.CLEARED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>cleared</code>
		 * 	event.
		 * 
		 *  <p>The properties of the event object have the following values:</p>
		 *  <table class="innertable">
