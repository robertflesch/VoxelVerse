...
package org.flashapi.swing.event {
	...
	* @version 1.0.1, 12/05/2011 18:38
	...
	*/
	...
	/**
	 *  The <code>CubicViewEvent</code> class represents event objects specific to 
	 *  <code>CubicView</code> classes.
	 * 
	 * 	@see org.flashapi.swing.CubicView
	 *
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha 5.7
	 */
	public class CubicViewEvent extends SpasEvent {
		...
		/**
		 *  Constructor.	Creates a new <code>CubicViewEvent</code> with the specified
		 * 					parameters.
		 *
		 ...
		 * 						can be prevented.
		 */
		public function CubicViewEvent(type:String, bubbles:Boolean=false, cancelable:Boolean=false) {
		...
		/**
		 *  The <code>CubicViewEvent.EFFECT_FINISHED</code> constant defines the value of the 
		 *  <code>type</code> property of the event object for a <code>effectFinished</code>
		 * 	event.
		 * 
		...
		override public function clone():Event {
			return new CubicViewEvent(type, bubbles, cancelable);
		}
	}
}