...
package org.flashapi.swing.plaf.basic {
	...
	// -----------------------------------------------------------
	// BasicPictureFlowUI.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.0, 12/07/2008 17:00
	...
	*/
	...
	/**
	 * 	The <code>BasicPictureFlowUI</code> class is the SPAS 3.0 "flex-like" look and feel
	 ...
	 */
	public class BasicPictureFlowUI extends BasicUI implements PictureFlowUI {
		 ...
		 */
		public function BasicPictureFlowUI(dto:LafDTO) {
			super(dto); 
		}
