...
package org.flashapi.swing.plaf.basic {
	...
	* @version 1.0.1, 09/12/2008 01:40
	...
	*/
	...
	/**
	 * 	The <code>BasicDockUI</code> class is the SPAS 3.0 "flex-like" look and feel
	 ...
	 */
	public class BasicDockUI extends BasicUI implements DockUI {
		 ...
		 */
		public function BasicDockUI(dto:LafDTO) {
			super(dto);
		}
		...
		public function drawTray():void {
			...
			f.clear();
			f.lineStyle(0, 0xCCCCCC, .8);
			f.beginFill(0xE8E8E8, .5);
		...
		private var _textFormat:UITextFormat = new UITextFormat(WebFonts.VERDANA, 13, 0xFFFFFF, true);
	}
}