...
package org.flashapi.swing.plaf.basic {
	...
	// -----------------------------------------------------------
	// BasicMenuButtonUI.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.1, 28/12/2008 14:06
	...
	*/
	...
	/**
	 * 	The <code>BasicMenuButtonUI</code> class is the SPAS 3.0 "flex-like" look and feel
	 * 	for <code>MenuButtonUI</code> instances.
	 * 
	 ...
	 */
	public class BasicMenuButtonUI extends BasicRadioIconColorsUI implements MenuButtonUI {
		 ...
		 */
		public function BasicMenuButtonUI(dto:LafDTO) {
			super(dto);
		}
