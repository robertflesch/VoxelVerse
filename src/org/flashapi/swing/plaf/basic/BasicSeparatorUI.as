...
package org.flashapi.swing.plaf.basic {
	...
	* @version 1.0.0, 29/01/2008 12:53
	...
	*/
	...
	/**
	 * 	The <code>BasicSeparatorUI</code> class is the SPAS 3.0 "flex-like" look and feel
	 ...
	 */
	public class BasicSeparatorUI extends BasicUI implements SeparatorUI {
		 ...
		 */
		public function BasicSeparatorUI(dto:LafDTO) {
			super(dto);
		}
		...
		private var _line1:Array = [1, 0x585F63, .8];
		private var _line2:Array = [1, 0xFFFFFF, 1];
	}
}