...
package org.flashapi.swing.plaf.basic.brushes {
	...
	* @version 1.0.1, 20/01/2009 15:07
	...
	*/
	...
	/**
	 * 	The <code>BasicRestoreIcon</code> class renders restoring icons used by 
	 ...
	 */
	public class BasicRestoreIcon extends StateBrushBase implements StateBrush {
		 ...
		 */
		public function BasicRestoreIcon(target:*, rect:Rectangle = null, dto:LafDTO = null) {
		...
		override protected function drawBrushShape(state:String):void {
			...
			with ($graphics) {
				...
				moveTo(_x-1, _y+3);
				lineStyle(2, color, 1, false, "normal", "none");
				lineTo(_w/2+2.5, _y+3);
				moveTo(_w/2+2, _y+3);
				lineStyle(1, color, 1, false, "normal", "none");
