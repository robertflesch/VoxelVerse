...
package org.flashapi.swing.plaf.basic.brushes {
	...
	// -----------------------------------------------------------
	// BasicRadioButtonIcon.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.2, 10/02/2010 10:12
	...
	*/
	...
	/**
	 * 	The <code>BasicRadioButtonIcon</code> class renders icons used by <code>RadioButton</code>
	 * 	objects for the SPAS 3.0 "flex-like" Look and Feel.
	 * 
	 ...
	 */
	public class BasicRadioButtonIcon extends StateBrushBase implements StateBrush {
		 ...
		 */
		public function BasicRadioButtonIcon(target:*, rect:Rectangle = null, dto:LafDTO = null) {
			...
			switch(state) {
				case States.OUT :
					...
					bg = (dto.colors.up != StateObjectValue.NONE) ?
						new AltColors(dto.colors.up) : { color3:0xFFFFFF, color4:0xDDDDDD };
					break;
				case States.OVER :
					...
					bg = (dto.colors.over != StateObjectValue.NONE) ?
						new AltColors(dto.colors.over) : { color3:0xFFFFFF, color4:0xDDDDDD };
					break;
				case States.PRESSED : 
