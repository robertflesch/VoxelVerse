...
package org.flashapi.swing.plaf.basic {
	...
	// -----------------------------------------------------------
	// BasicRadioButtonUI.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.1, 28/12/2008 13:58
	...
	*/
	...
	import org.flashapi.swing.plaf.basic.brushes.BasicRadioButtonIcon;
	import org.flashapi.swing.plaf.core.LafDTO;
	import org.flashapi.swing.plaf.RadioButtonUI;
	import org.flashapi.swing.text.FontFormat;

	/**
	 * 	The <code>BasicRadioButtonUI</code> class is the SPAS 3.0 "flex-like" look and feel
	 ...
	 */
	public class BasicRadioButtonUI extends BasicRadioIconColorsUI implements RadioButtonUI {
		 ...
		 */
		public function BasicRadioButtonUI(dto:LafDTO) {
			super(dto);
		}
		...
		private var _fontFormat:FontFormat = new FontFormat(WebFonts.VERDANA, 12);
