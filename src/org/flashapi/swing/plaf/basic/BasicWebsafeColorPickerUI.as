...
package org.flashapi.swing.plaf.basic {
	...
	// -----------------------------------------------------------
	// BasicWebsafeColorPicker.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.0, 07/01/2008 21:23
	...
	*/
	...
	/**
	 * 	The <code>BasicWebsafeColorPickerUI</code> class is the SPAS 3.0 "flex-like" look and feel
	 ...
	 */
	public class BasicWebsafeColorPickerUI extends BasicUI implements WebsafeColorPickerUI {
		 ...
		 */
		public function BasicWebsafeColorPickerUI(dto:LafDTO) {
			super(dto);
		}
