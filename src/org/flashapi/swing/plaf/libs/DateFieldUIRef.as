...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 15/03/2010 21:22
	* @see http://www.flashapi.org/
	*/
	
	import org.flashapi.swing.plaf.spas.SpasDateFieldUI;
	import org.flashapi.swing.util.Observable;
	
	/**
	 * 	<strong>FOR DEVELOPERS ONLY.</strong>
	 * 
	 * 	The <code>DateFieldUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>DateField</code> objects.
	 * 
	 ...
	 */
	public class DateFieldUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>DateFieldUIRef</code>
		 * 	Library.
		 * 
