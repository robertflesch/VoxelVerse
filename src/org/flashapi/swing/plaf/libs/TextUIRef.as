...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 17/03/2010 22:16
	...
	*/
	 ...
	 * 
	 * 	The <code>TextUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>Text</code> objects.
	 * 
	 ...
	 */
	public class TextUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>TextUIRef</code>
		 * 	Library.
		 * 
