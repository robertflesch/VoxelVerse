...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 17/03/2010 22:30
	* @see http://www.flashapi.org/
	*/
	
	import org.flashapi.swing.plaf.spas.SpasThumbnailUI;
	import org.flashapi.swing.util.Observable;
	
	/**
	 * 	<strong>FOR DEVELOPERS ONLY.</strong>
	 * 
	 * 	The <code>ThumbnailUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>Thumbnail</code> objects.
	 * 
	 ...
	 */
	public class ThumbnailUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>ThumbnailUIRef</code>
		 * 	Library.
		 * 
