...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 14/03/2010 18:55
	* @see http://www.flashapi.org/
	*/
	
	import org.flashapi.swing.plaf.spas.SpasBoxUI;
	import org.flashapi.swing.util.Observable;
	
	/**
	 * 	<strong>FOR DEVELOPERS ONLY.</strong>
	 * 
	 * 	The <code>BoxUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>Box</code> objects.
	 * 
	 ...
	 */
	public class BoxUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>BoxUIRef</code>
		 * 	Library.
		 * 
