...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 17/03/2010 22:29
	* @see http://www.flashapi.org/
	*/
	
	import org.flashapi.swing.plaf.spas.SpasTextInputUI;
	import org.flashapi.swing.util.Observable;
	
	/**
	 * 	<strong>FOR DEVELOPERS ONLY.</strong>
	 * 
	 * 	The <code>TextInputUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>TextInput</code> objects.
	 * 
	 ...
	 */
	public class TextInputUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>TextInputUIRef</code>
		 * 	Library.
		 * 
