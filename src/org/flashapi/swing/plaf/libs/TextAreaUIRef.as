...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 17/03/2010 22:28
	* @see http://www.flashapi.org/
	*/
	
	import org.flashapi.swing.plaf.spas.SpasTextAreaUI;
	import org.flashapi.swing.util.Observable;
	
	/**
	 * 	<strong>FOR DEVELOPERS ONLY.</strong>
	 * 
	 * 	The <code>TextAreaUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>TextArea</code> objects.
	 * 
	 ...
	 */
	public class TextAreaUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>TextAreaUIRef</code>
		 * 	Library.
		 * 
