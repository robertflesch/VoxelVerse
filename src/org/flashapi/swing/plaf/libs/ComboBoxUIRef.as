...
package org.flashapi.swing.plaf.libs {
	...
	* @version 1.0.0, 15/03/2010 21:16
	* @see http://www.flashapi.org/
	*/
	
	import org.flashapi.swing.plaf.spas.SpasComboBoxUI;
	import org.flashapi.swing.util.Observable;
	
	/**
	 * 	<strong>FOR DEVELOPERS ONLY.</strong>
	 * 
	 * 	The <code>ComboBoxUIRef</code> is the Library Reference for 
	 * 	Look And Feel of <code>ComboBox</code> objects.
	 * 
	 ...
	 */
	public class ComboBoxUIRef implements LafLibRef {
		
		/**
		 * 	<strong>FOR DEVELOPERS ONLY.</strong>
		 * 
		 * 	Returns the default Look And Feel reference for the <code>ComboBoxUIRef</code>
		 * 	Library.
		 * 
