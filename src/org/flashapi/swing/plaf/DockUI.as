...
package org.flashapi.swing.plaf {
	...
	*/
	...
	/**
	 * 	The <code>DockUI</code> interface defines the interface required to
	 * 	create <code>Dock</code> look and feels.
	 * 
	 ...
	 */
	public interface DockUI extends LookAndFeel {
		
		/**
		 * 	Draws the dock track (icon tray).
		 */
