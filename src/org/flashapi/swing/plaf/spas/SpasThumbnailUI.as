...
package org.flashapi.swing.plaf.spas {
	...
	* @version 1.0.2, 10/11/2010 17:19
	...
	*/
	...
	/**
	 * 	The <code>SpasThumbnailUI</code> class is the SPAS 3.0 default look and feel
	 ...
	 */
	public class SpasThumbnailUI extends SpasIconColorsUI implements ThumbnailUI {
		 ...
		 */
		public function SpasThumbnailUI(dto:LafDTO) {
			super(dto);
		}
		...
		public function drawOverState():void {
			...
			dto.icon.glowColor = !isNaN(dto.glowColor) ? dto.glowColor : getGlowFilter().color;
			dto.icon.glow = true;
