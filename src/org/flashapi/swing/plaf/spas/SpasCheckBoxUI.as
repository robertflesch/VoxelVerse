...
package org.flashapi.swing.plaf.spas {
	...
	* @version 1.0.2, 09/11/2010 17:12
	...
	*/
	...
	import org.flashapi.swing.plaf.spas.brushes.SpasCheckBoxIcon;
	import org.flashapi.swing.text.FontFormat;
	
	
	/**
	 * 	The <code>SpasCheckBoxUI</code> class is the SPAS 3.0 default look and feel
	 ...
	 */
	public class SpasCheckBoxUI extends SpasRadioIconColorsUI implements CheckBoxUI {
		 ...
		 */
		public function SpasCheckBoxUI(dto:LafDTO) {
			super(dto);
		}
