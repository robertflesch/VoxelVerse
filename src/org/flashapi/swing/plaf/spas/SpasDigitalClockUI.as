...
package org.flashapi.swing.plaf.spas {
	...
	// -----------------------------------------------------------
	// SpasDigitalClockUI.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.0, 10/04/2009 12:18
	...
	*/
	...
	/**
	 * 	The <code>SpasDigitalClockUI</code> class is the SPAS 3.0 default look and feel
	...
	public class SpasDigitalClockUI extends SpasUI implements DigitalClockUI {
		 ...
		 */
		public function SpasDigitalClockUI(dto:LafDTO) {
			super(dto);
		}
