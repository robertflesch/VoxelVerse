...
package org.flashapi.swing.plaf.spas {
	...
	* @version 1.0.1, 09/11/2010 13:03
	...
	*/
	...
	/**
	 * 	The <code>SpasBubbleHelpUI</code> class is the SPAS 3.0 default look and feel
	...
	public class SpasBubbleHelpUI extends SpasUI implements BubbleHelpUI {
		 ...
		 */
		public function SpasBubbleHelpUI(dto:LafDTO) {
			super(dto);
		}
		...
		public function drawAnchor():void {
			...
			with (dto.currentTarget.graphics) {
				beginFill(c, _backgroundAlpha);
				lineStyle(bw, c, ba, true);
				if(vert) {
					moveTo(sx - s, o);
					lineTo(sx + s, o);
		...
		private var _backgroundAlpha:Number = .6;
	}
}