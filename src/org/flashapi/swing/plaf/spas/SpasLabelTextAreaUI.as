...
package org.flashapi.swing.plaf.spas {
	...
	// -----------------------------------------------------------
	// SpasLabelTextAreaUI.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 1.0.0, 26/12/2010 22:26
	...
	*/
	...
	/**
	 * 	The <code>SpasLabelTextAreaUI</code> class is the SPAS 3.0 default look and feel
	 ...
	 */
	public class SpasLabelTextAreaUI extends SpasUI implements LabelTextAreaUI {
		 ...
		 */
		public function SpasLabelTextAreaUI(dto:LafDTO) {
			super(dto);
		}
