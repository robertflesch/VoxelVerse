...
package org.flashapi.swing.plaf.spas.brushes {
	...
	*/
	...
	/**
	 * 	The <code>SpasRadioButtonIcon</code> class renders icons used by <code>RadioButton</code>
	 ...
	 */
	public class SpasRadioButtonIcon extends StateBrushBase implements StateBrush {
		 ...
		 */
		public function SpasRadioButtonIcon(target:*, rect:Rectangle = null, dto:LafDTO = null) {
		...
		private function initObj():void {
			if (_matrix == null) {
				_matrix = new Matrix();
				_matrix.createGradientBox(18, 18, Math.PI/2, 0, 0);
			}
		...
		private function drawRadioButtonIcon(lineColor1:uint, lineColor2:uint, buttonColor1:uint, buttonColor2:uint, state:String):void {
			...
			with($graphics) {
				...
				c = ColorStateUtil.getColor(state, $colors);
				lineStyle(0, c);
				beginFill(c);
