...
package org.flashapi.swing.plaf.spas {
	...
	// -----------------------------------------------------------
	// SpasSelectableItemUI.as
	// -----------------------------------------------------------

	/**
	* @author Pascal ECHEMANN
	* @version 2.0.0, 10/11/2010 10:07
	...
	*/
	...
	/**
	 * 	The <code>SpasSelectableItemUI</code> class is the SPAS 3.0 default look and feel
	 ...
	 */
	public class SpasSelectableItemUI extends SpasRadioIconColorsUI implements SelectableItemUI {
		 ...
		 */
		public function SpasSelectableItemUI(dto:LafDTO) {
			super(dto);
		}
