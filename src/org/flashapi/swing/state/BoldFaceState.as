...
package org.flashapi.swing.state {
	...
	*/
	...
	/**
	 * 	The <code>BoldFaceState</code> class allows to manage different states
	 * 	for <code>UIObject</code> instances that define specific font weight
	 * 	for each state.
	 * 
	 ...
	 */
	public class BoldFaceState extends StateObjectBase implements StateObject {
		...
		/**
		 * 	Constructor. Creates a new <code>BoldFaceState</code> object with the
		 * 	specified parameter.
		 * 
		 * 	@param	uio	The <code>IUIObject</code> instance that implement this
		 * 				<code>BoldFaceState</code> object.
		 */	
		public function BoldFaceState(uio:IUIObject) {
			super(uio);
		}
