...
package org.flashapi.tween.motion {
	...
	* @version 1.0.1, 09/03/2010 12:12
	...
	*/
	...
	/**
	 * 	The <code>Back</code> class defines three easing functions to implement
	 * 	motion with SPAS 3.0 BeeTween animations.
	 * 
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class Back extends AbstractEasing implements Easing {
		...
		/**
		 * 	Constructor. 	Creates a new <code>Back</code> object with the 
		 ...
		 */
		public function Back(type:String = "in") {
			super(this, type);
		}
		 ...
		 * 				the greater the overshoot. Default value is <code>1.70158</code>.
		 * 
		...
		/**
		 * 	Starts the motion by moving towards the target, overshooting it slightly, and
		 * 	then reversing direction back toward the target.
		 * 
		 * 	@param	t	Specifies the current time, between <code>0</code> and duration
		 * 				inclusive.
		 * 	@param	b	Specifies the initial value of the animation property.
		 ...
		 * 	methods to start the motion by backtracking, then reversing direction and
		 * 	moving toward the target, overshooting the target slightly, reversing direction
		 ...
		 *  @see http://www.robertpenner.com/profmx
		 */
		public static function easeBoth(t:Number, b:Number, c:Number, d:Number, s:Number = 1.70158):Number {
