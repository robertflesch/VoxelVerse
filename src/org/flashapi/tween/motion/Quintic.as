...
package org.flashapi.tween.motion {
	...
	*/
	...
	/**
	 * 	The <code>Quintic</code> class defines three easing functions to implement
	 * 	motion with SPAS 3.0 BeeTween animations. The acceleration of motion for a 
	 * 	<code>Quintic</code> easing equation is greater than for a <code>Quartic</code>
	 * 	easing equation.
	 * 
	 * 	@see org.flashapi.tween.effect.Quartic
	 * 
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class Quintic extends AbstractEasing implements Easing {
		...
		/**
		 * 	Constructor. 	Creates a new <code>Quintic</code> object with the 
		 ...
		 */
		public function Quintic(type:String = "in") {
			super(this, type);
		}
