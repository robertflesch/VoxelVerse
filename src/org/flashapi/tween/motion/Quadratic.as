...
package org.flashapi.tween.motion {
	...
	* @version 1.0.1, 09/03/2010 12:10
	...
	*/
	...
	/**
	 * 	The <code>Quadratic</code> class defines three easing functions to implement
	 * 	accelerated motion with SPAS 3.0 BeeTween animations. The acceleration of
	 * 	motion for a <code>Quadratic</code> easing equation is the same as for a
	 * 	timeline tween at <code>100%</code> easing and is less dramatic than for the
	 * 	<code>Cubic</code> easing equation.
	 * 
	 * 	@see org.flashapi.tween.effect.Quadratic
	 * 
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class Quadratic extends AbstractEasing implements Easing {
		...
		/**
		 * 	Constructor. 	Creates a new <code>Quadratic</code> object with the
		 ...
		 */
		public function Quadratic(type:String = "in") {
			super(this, type);
		}
		...
		/**
		 * 	Starts fast and then decelerates motion to a zero velocity as it executes.
		 * 
		 * 	@param	t	Specifies the current time, between <code>0</code> and duration
		 * 				inclusive.
		 * 	@param	b	Specifies the initial value of the animation property.
