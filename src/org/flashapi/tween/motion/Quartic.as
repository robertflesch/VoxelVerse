...
package org.flashapi.tween.motion {
	...
	*/
	...
	/**
	 * 	The <code>Quartic</code> class defines three easing functions to implement
	 * 	motion with SPAS 3.0 BeeTween animations. The acceleration of motion for a
	 * 	<code>Quartic</code> easing equation is greater than for a <code>Cubic</code>
	 * 	easing equation.
	 * 
	 * 	@see org.flashapi.tween.effect.Cubic
	 * 
	 * 	@langversion ActionScript 3.0
	 * 	@playerversion Flash Player 9
	 * 	@productversion SPAS 3.0 alpha
	 */
	public class Quartic extends AbstractEasing implements Easing {
		...
		/**
		 * 	Constructor. 	Creates a new <code>Quartic</code> object with the 
		 ...
		 */
		public function Quartic(type:String = "in") {
			super(this, type);
		}
