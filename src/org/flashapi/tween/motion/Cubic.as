...
package org.flashapi.tween.motion {
	...
	* credit: Based upon Robert Penner's Easing Equations v1.3 - Oct. 29, 2002 - (c) 2002 Robert Penner.
	...
	*/
	...
	/**
	 * 	The <code>Cubic</code> class defines three easing functions to implement
	 * 	motion with SPAS 3.0 BeeTween animations. The acceleration of motion for a 
	 * 	<code>Cubic</code> easing equation is greater than for a <code>Quadratic</code>
	 * 	easing equation.
	 * 
	 ...
	 */
	public class Cubic extends AbstractEasing implements Easing {
		...
		/**
		 * 	Constructor. 	Creates a new <code>Cubic</code> object with the 
		 ...
		 */
		public function Cubic(type:String = "in") {
			super(this, type);
		}
