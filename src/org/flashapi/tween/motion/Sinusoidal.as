...
package org.flashapi.tween.motion {
	...
	* @version 1.0.1, 09/03/2010 12:09
	...
	*/
	...
	/**
	 * 	The <code>Sinusoidal</code> class defines three easing functions to implement
	 * 	motion with SPAS 3.0  BeeTween animations. The acceleration of motion for a 
	 * 	<code>Sinusoidal</code> easing equation is less than that for a <code>Quadratic</code>
	 * 	equation.
	 * 
	 ...
	 */
	public class Sinusoidal extends AbstractEasing implements Easing {
		...
		/**
		 * 	Constructor. 	Creates a new <code>Sinusoidal</code> object with the 
		 ...
		 */
		public function Sinusoidal(type:String = "in") {
			super(this, type);
		}
