...
package com.voxelengine.worldmodel.tasks.landscapetasks
{
	 ...
	 */
	public class LandscapeError extends LandscapeTask 
	{		
		public function LandscapeError( guid:String, layer:LayerInfo ):void {
			trace( "LandscapeError - ERROR - ERROR" );					
			super(guid, layer, "Test Error");
		}
		...
		override public function start():void {
			...
			trace( "LandscapeError.start - took: "  + (getTimer() - timer) );					
